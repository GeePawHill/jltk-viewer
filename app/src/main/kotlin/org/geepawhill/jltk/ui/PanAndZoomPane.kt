...
class PanAndZoomPane(private val target: Node) : ScrollPane() {
    ...
    public fun refitTo(newWidth: Double, newHeight: Double) {
        val widthRatio = width / newWidth
        val heightRatio = height / newHeight
        scaleValue = if (heightRatio > widthRatio) widthRatio else heightRatio
    }
